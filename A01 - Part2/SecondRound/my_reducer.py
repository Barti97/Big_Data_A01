...
def my_reduce(my_input_stream, my_output_stream, my_reducer_input_parameters):
    ...
    totalRanOuts = my_reducer_input_parameters[0]
    for t in sorted(myDict.items(), key=lambda item: item[1], reverse=True):
        percentage = (t[1] / totalRanOuts)*100
        my_output_stream.write( t[0] +'\t(' + str(t[1]) + ', ' + str(percentage) + ')\n')
