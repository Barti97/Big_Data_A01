...
def my_main(my_list, station_names):
    ...
    my_list = my_map(lambda item: (item[1], item[5]), my_list) # -> Replace None with a call to my_map
    ...
    my_list = my_filter(lambda item: item[1] == 0, my_list) # -> Replace None with a call to my_filter
    ...
    my_list = my_filter(lambda item: item[0] in station_names, my_list) # -> Replace None with a call to my_filter
    ...
    my_list = my_map(lambda item: (item[0], 1), my_list) # -> Replace None with a call to my_map
